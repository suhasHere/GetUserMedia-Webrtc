...

{
  ...
  'targets': [
    ...
    #
    {
      ...
      'sources': [
	# Transport
	'./transport/WebRTCAudioDeviceLayer.h',
	'./transport/WebRTCAudioDeviceLayer.cpp',
	'./transport/AudioSession.h',
	'./transport/AudioSession.cpp',
	'./transport/VideoSession.h',
	'./transport/VideoSession.cpp',
        # Common
