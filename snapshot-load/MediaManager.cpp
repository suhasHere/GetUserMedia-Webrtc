...
public:
  ...
  Run()
  {
    ...
    //nsRefPtr<SourceMediaStream> stream = comStream->GetStream()->AsSourceStream();
    //mSource->Start(stream, 1);
...
public:
  ...
  Run()
  {
    ...
    printf("\n +++++ SUHAS : GETUSERMEDIARUNNABLE PICTURE IS %d", mPicture);
    if (mPicture) {
    printf("\n +++++ SUHAS : GETUSERMEDIARUNNABLE SENDPICTURE ");
      SendPicture();
      return NS_OK;
    }
